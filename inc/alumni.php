 ...
 class CC_Alumni {
  ...
  public function redirect_if_logged_in () {
    ...
    if ( $this->is_alumni() && is_page( $this->alumni_login_id ) ) {
      $return_url = esc_url( get_page_link( $this->alumni_home_id ) );
  ...
  <div class="alumni-dropdown navbar-dropdown">
    <a class="navbar-item" href="'. get_page_link( $this->alumni_home_id ) .'">Alumni</a>
